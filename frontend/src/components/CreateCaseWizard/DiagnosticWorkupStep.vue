  ...
  <div class="space-y-6">
    ...
    <Card>
      <div class="p-6">
        ...
        <div class="space-y-4">
          <div v-for="test in labTests" :key="test.key" class="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0">
  ...
  >
    <div class="flex items-center space-x-4 flex-1 max-w-xs">
      <input
        :id="study.key"
        type="checkbox"
        :checked="diagnosticWorkup.imagingStudies?.includes(study.key)"
    ...
    <div class="flex-1 w-full sm:ml-4">
      <Textarea
        :placeholder="$t('createCase.findings')"
        v-model="diagnosticWorkup.imagingFindings[study.key]"
        class="w-full"
        rows="2"
      />
    </div>
    ...
    <Card>
      <div class="p-6">
        ...
        <div class="space-y-4">
          <div v-for="test in otherTests" :key="test.key" class="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0">
            <div class="flex items-center space-x-4 flex-1 max-w-xs">
