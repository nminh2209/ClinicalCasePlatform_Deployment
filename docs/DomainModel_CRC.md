...
- **Relationships:**
  ...
  - Has PasswordResetTokens

### Password Reset Token (Conceptual Entity)
...
- **Notes:**
  ...
  - Sent via email with reset link
    ...
    | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    | User              | id, name, email, password_hash, role, is_oauth_user, oauth_provider, created_at                                                                                                       | register(), login(), resetPassword(), oauthLogin(), createCase(), searchCases(), exportCase(), giveFeedback(), commentOnCase(), updateProfile() | Creates Cases, Owns Repositories, Creates Templates, Gives Feedback, Writes Comments, Receives CasePermissions, Creates Exports, Gives Grades, Has Sessions, Uploads MedicalAttachments, Has PasswordResetTokens |
    | PasswordResetToken | user_id, token_hash, uid_base64, created_at, expires_at, is_used                                                                                                                      | generate(), validate(), markAsUsed(), isExpired()                                                                | Belongs to User                                                                                                                                                                         |
