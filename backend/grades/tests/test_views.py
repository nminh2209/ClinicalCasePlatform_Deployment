...
class TestGradeViews:
    ...
    def test_instructor_can_grade_case(
        self, instructor_client, graded_case, instructor_user
    ):
    ...
    def test_student_cannot_grade_own_case(
        self, authenticated_client, graded_case, student_user
    ):
    ...
    def test_student_can_view_own_grades(
        self, authenticated_client, graded_case, instructor_user
    ):
    ...
    def test_grade_validation_score_range(
        self, instructor_client, graded_case, instructor_user
    ):
    ...
    def test_update_grade(self, instructor_client, graded_case, instructor_user):
        ...
        response = instructor_client.patch(
            f"/api/grades/{grade.id}/", data, format="json"
        )
        assert response.status_code in [
            status.HTTP_200_OK,
            status.HTTP_404_NOT_FOUND,
    ...
    def test_grade_with_detailed_criteria(
        self, instructor_client, graded_case, instructor_user
    ):
...
class TestCommentViews:
    ...
    def test_reply_to_comment(self, authenticated_client, commented_case, student_user):
        ...
        parent_comment = Comment.objects.create(
            case=commented_case, author=student_user, content="Original comment"
        )
    ...
    def test_list_case_comments(
        self, authenticated_client, commented_case, student_user
    ):
        """Test listing all comments for a case."""
        from comments.models import Comment

        Comment.objects.create(
            case=commented_case, author=student_user, content="Comment 1"
        )
        Comment.objects.create(
            case=commented_case, author=student_user, content="Comment 2"
        )
    ...
    def test_edit_own_comment(self, authenticated_client, commented_case, student_user):
        ...
        comment = Comment.objects.create(
            case=commented_case, author=student_user, content="Original content"
        )
    ...
    def test_cannot_edit_others_comment(
        self, api_client, commented_case, student_user, cardiology_department
    ):
    ...
    def test_delete_own_comment(
        ...
        comment = Comment.objects.create(
            case=commented_case, author=student_user, content="To be deleted"
        )
