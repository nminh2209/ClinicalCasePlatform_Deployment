...
class TestGradeModel:
    ...
    def grade_data(self, instructor_user, student_user, test_repository):
        ...
        return {"case": case, "graded_by": instructor_user, "student": student_user}
    ...
    def test_grade_score_validation(self, grade_data):
        ...
        grade = Grade.objects.create(
            case=grade_data["case"], graded_by=grade_data["graded_by"], score=95
        )
    ...
    def test_grade_timestamps(self, grade_data):
        ...
        grade = Grade.objects.create(
            case=grade_data["case"], graded_by=grade_data["graded_by"], score=80
        )
