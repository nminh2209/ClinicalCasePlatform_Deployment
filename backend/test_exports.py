...
def test_exports():
    ...
    print(f"📁 Check your backend directory for generated files:")
    print(f"   - test_export.pdf")
    print(f"   - test_export.docx")
    print(f"   - test_export.json")
    if templates.exists():
        print(f"   - test_export_with_template.pdf")
