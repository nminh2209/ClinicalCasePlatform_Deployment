...
class TestCaseApprovalWorkflow:
    ...
    def test_instructor_approve_case(
    ...
    def test_instructor_reject_case(
        self, api_client, instructor_user, student_user, test_repository
    ):
    ...
    def test_instructor_request_revision(
        self, api_client, instructor_user, student_user, test_repository
    ):
...
class TestCaseStatusTransitions:
    ...
    def test_cannot_transition_approved_to_draft(
        self, api_client, student_user, test_repository
    ):
