...
class TestCasePermissions:
    ...
    def test_student_cannot_view_others_draft(
    ...
    def test_instructor_can_view_student_case(
    ...
    def test_student_cannot_delete_approved_case(
...
class TestCaseCloning:
    ...
    def test_clone_with_modifications(
        ...
        response = api_client.post(
            f"/api/cases/{original.id}/clone/", data, format="json"
        )
...
class TestCaseEdgeCases:
    ...
    def test_create_case_extremely_old_patient(
        self, api_client, student_user, test_repository
    ):
