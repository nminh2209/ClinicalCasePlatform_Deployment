            ...
            with transaction.atomic():
                ...
                template1, created = CaseTemplate.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        'fields_schema': {
                            'sections': ['history', 'examination', 'investigations', 'diagnosis', 'treatment'],
                            'required_fields': ['patient_name', 'patient_age', 'history', 'examination'],
                            'cardiology_specific': ['chest_pain', 'ecg', 'echo', 'cardiac_enzymes']
                        },
                        'is_standard': True
                    }
                )
