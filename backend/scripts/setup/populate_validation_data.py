...
def create_validation_rules():
    ...
    for rule_data in rules:
        rule, created = CaseValidationRule.objects.get_or_create(
            name=rule_data["name"],
            defaults={**rule_data, "created_by": admin, "is_active": True},
        )
        if created:
            created_count += 1
...
def create_medical_terminology():
    ...
    terms = [
        ...
        (
            ...
            "Chụp cộng hưởng từ",
            "Procedure",
            "Chẩn đoán hình ảnh bằng từ trường",
        ...
        (
            ...
            "Siêu âm",
            "Procedure",
            "Chẩn đoán hình ảnh bằng sóng âm",
            ["Sonography"],
        ),
        (
            "ECG",
            "Điện tim",
            "Procedure",
            "Ghi nhận hoạt động điện của tim",
