...
SAMPLE_ICD = [
    {'code': 'A90', 'description_en': 'Dengue fever [classical dengue]', 'description_vi': 'Sốt xuất huyết Dengue'},
    {'code': 'J18', 'description_en': 'Pneumonia, unspecified organism', 'description_vi': 'Viêm phổi không rõ tác nhân'},
]
